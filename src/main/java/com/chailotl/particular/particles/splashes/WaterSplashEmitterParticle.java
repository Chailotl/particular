...
public class WaterSplashEmitterParticle extends NoRenderParticle
{
	...
	WaterSplashEmitterParticle(ClientWorld clientWorld, double x, double y, double z, float width, float speed)
	{
		...
		clientWorld.addParticle(Particles.WATER_SPLASH, false, true, x, y, z, width, this.height, 0);
		clientWorld.addParticle(Particles.WATER_SPLASH_FOAM, false, true, x, y, z, width, this.height, 0);
		clientWorld.addParticle(Particles.WATER_SPLASH_RING, false, true, x, y, z, width, 0, 0);
	...
	public void tick()
	{
		...
		if (age == 8)
		{
			world.addParticle(Particles.WATER_SPLASH, false, true, x, y, z, width * 0.66f, height * 2f, 0);
			world.addParticle(Particles.WATER_SPLASH_FOAM, false, true, x, y, z, width * 0.66f, height * 2f, 0);
			world.addParticle(Particles.WATER_SPLASH_RING, false, true, x, y, z, width * 0.66f, 0, 0);
